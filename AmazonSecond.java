...
public class  AmazonSecond{
    ...
    public void selectButton() throws InterruptedException {
        //ios信息
        String searchWordXpath_UK="//XCUIElementTypeApplication[@name=\"08-tianqi\"]/" +
                "XCUIElementTypeWindow[1]/XCUIElementTypeOther/XCUIElementTypeTextField[1]";
        String searchWord_UK;
        //String Amazon="//XCUIElementTypeIcon[@name=\"亚马逊购物\"]";
        String goAmazon="跳转亚马逊";
        ...
        searchWord_UK=driver.findElement(By.xpath(searchWordXpath_UK)).getText();
        buttonClick(goAmazon);
//        driver.closeApp();

        //driver.findElement(By.xpath(Amazon)).click();
///用户登录退出2
